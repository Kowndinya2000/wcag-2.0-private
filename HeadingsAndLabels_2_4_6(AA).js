...
function HeadingsAndLabels() {
    ...
    $(document).ready(function () {
        ...
        if (h1R < h2R && h1R < h3R && h1R < h4R && h1R < h5R && h1R < h6R) {
            ...
            console.log("-----------------------------------------")
            console.log("Rule: WCAG 2.4.6 (2.0,AA)")
            //console.log("[Known Problem] Violation 2.4.6! Header nesting - header following h1 is incorrect.")
            console.log("Error: Header nesting - header following h1 is incorrect.")
            if (h1R > 0) {
                console.log("Code Snippet: ", document.getElementsByTagName("h1")[0].outerHTML)

            }
            console.log("Fix: Modify the header levels so only an h1 or h2 follows h1.")
        }
