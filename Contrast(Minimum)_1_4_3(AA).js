                ...
                if (fontWeight == "normal" || fontWeightNumber < 700) {
                    ...
                    if (fS < 18) {
                        ...
                        if (icontrast < 4.5) {
                            ...
                            console.log("-----------------------------------------")
                            console.log("Rule: WCAG 1.4.3 (2.0,AA)")
                            console.log("Error: Violation 1.4.3! The contrast between the colour of text and its background for the element is not sufficient to meet WCAG2.0 Level AA.")
                            console.log("Code Snippet: ", $(this))
                            console.log("Fix: Use a colour contrast evaluator to determine if text and background colours provide a contrast ratio of 4.5:1 for standard text, or 3:1 for larger text. Change colour codes to produce sufficient contrast.")
                        }
