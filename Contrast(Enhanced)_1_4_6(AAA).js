// Requirement
// Text colour must provide high contrast with its background colour
// Error
// The contrast between the colour of text and its background is not sufficient to meet WCAG2.0 Level AAA.
// Short Description
// The visual presentation of text must have a contrast ratio of at least 7:1, except for large-scale text, which must have a contrast ratio of at least 4.5:1 as determined by a contrast algorithm specified by WCAG2.0. Large scale text is considered to be at least 18-point (or 14 point when bold).
// Rationale
...
// How To Repair
// Use a colour contrast evaluator to determine if text and background colours provide a contrast ratio of 7:1 for standard text, or 4.5:1 for larger text. Change colour codes to produce sufficient contrast. 
            ...
            if ($(this).prop("nodeName") == "DIV" ||
                ...
                if (fontWeight == "normal" || fontWeightNumber < 700) {
                    ...
                    if (fS < 18) {
                        ...
                        if (icontrast < 7) {
                            // console.log("[Known Problem] Violation 1.4.6! The contrast ratio must be greater than 4.5:1 for normal small scale text")

                            console.log("-----------------------------------------")
                            console.log("Rule: WCAG 1.4.6 (2.0,AAA)")
                            console.log("Error: Violation 1.4.6! The contrast between the colour of text and its background for the element is not sufficient to meet WCAG2.0 Level AAA.")
                            console.log("Code Snippet: ", $(this))
                            console.log("Fix: Use a colour contrast evaluator to determine if text and background colours provide a contrast ratio of 7:1 for standard text, or 4.5:1 for larger text. Change colour codes to produce sufficient contrast.")
                        }
                        ...
                        if (e1contrast > 4.5) {
                            // console.log("[Known Problem] Violation 1.4.6! The contrast ratio must be greater than 4.5:1 for normal small scale text")
                            //                                console.log("[Known Problem] Violation 1.4.6! The contrast between the colour of text and its background for the element is not sufficient to meet WCAG2.0 Level AA.")
